...
from core.trainer import  eval_epoch,  train_epoch_adjoint_diff, train_epoch_adjoint_diff_momentum
...
parser.add_argument('--config', dest='config',
                    default="configs/cifar100/dyly_no_init/1_ode.yaml", type=str)
